...
# iihs_curation_dashboard
Front end dashboard to curate newsrack feeds using angular 4 

### To contribute follow below instructions for installation
...
```bash
$ git clone https://github.com/janastu/iihs_curation_dashboard.git
$ cd iihs_curation_dashboard
